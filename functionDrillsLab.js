...
function nameCheck(name){
  if(name === "Steven"){
    // console.log("Steven was entered");
    return "What is up Steven?"
  } else if (name === "Bryan"){
    // console.log("Bryan was entered")
    return "Hey Bryan!"
  } else {
...
const bestMovie = title => {
  console.log(`${movie} is the best movie`)
 return `${title} is the best movie ever!`
}
let faveMovie = bestMovie("Sharknado")
...
//   }
// }
//   let winners = theEliminator(con1, con2);
...
function chocoFrogs2(gold) {
  ...
  let totalFrogs = chocoFrogs2(100)
  console.log(chocoFrogs2(100))
